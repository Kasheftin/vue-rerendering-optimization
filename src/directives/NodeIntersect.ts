...
export default {
  inserted(el: HTMLBaseElement, { value: options }: DirectiveBinding) {
  ...
  update(el: HTMLBaseElementWithObserver, { value: newOptions }: DirectiveBinding) {
  ...
  unbind(el: HTMLBaseElementWithObserver) {
